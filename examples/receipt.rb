...
receipt_data = {id: "BC01-3652", customer: {dni: "00078647", legal_name: "Soledad Asuncion Carrasco Perez"},
                lines: [{id: "1", unit: "NIU", quantity: 1, item: {id: "REF564", description: "Refrigeradora marca \"AXM\" no frost de 200 ltrs"}, pricing_reference: 99800,
                       ...
                       {id: "2", unit: "NIU", quantity: 1, item: {id: "COC124", description: "Cocina a gas GLP, marca \"AXM\" de 5 hornillas"}, pricing_reference: 75000,
                          tax_totals: [{amount: 11441, type: :igv, code: "10"}], price: 63559, line_extension_amount: 63559},
                       {id: "3", unit: "NIU", quantity: 10, item: {id: "NOB012", description: "Sixpack de gaseosa \"Guaraná\" de 400 ml"}, pricing_reference: {amount: 480, free: true},
